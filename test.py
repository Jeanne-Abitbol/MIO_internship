...
for t in range(tt):
    vrt0[t] = v_richards_relative(t*dt, 0, P0[0, 0], vd_max, vr_max, delta)
    vrt20[t] = v_richards_relative(t*dt, 20, P0[0, np.int(20/dz)], vd_max, vr_max, delta)
    vrt200[t] = v_richards_relative(t*dt, 200, P0[0, np.int(200/dz)], vd_max, vr_max, delta)
